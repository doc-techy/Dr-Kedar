      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold mb-4 text-white">Dr. Kedar Hibare</h3>
            <p className={`${isDarkMode ? 'text-blue-400' : 'text-blue-300'} mb-4 font-medium`}>Lead Consultant - Clinical & Interventional Pulmonologist</p>
            <div className={`space-y-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-300'}`}>
            ...
            {/* Social Media Links */}
            <div className="mt-6">
              <h4 className="text-lg font-semibold mb-3 text-white">Connect with Dr. Hibare</h4>
              <div className="flex space-x-4">
                ...
                <a 
                  href="https://www.youtube.com/@kedarhibare" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="cursor-pointer text-red-500 hover:text-red-400 transition-colors hover:scale-110"
          ...
          <div className="lg:w-1/4">
            ...
            <div className={`space-y-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-300'}`}>
              ...
              <p className={`${isDarkMode ? 'text-blue-400' : 'text-blue-300'} mt-2`}>First in India - IAB Fellowship</p>
            </div>
          </div>
