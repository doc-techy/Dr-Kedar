export default function JsonLd() {
  ...
  const structuredData = {
    ...
    "alternateName": ["Dr. Kedar Hibare - Interventional Pulmonologist", "Lung Focus"],
    "jobTitle": "Lead Consultant - Clinical & Interventional Pulmonologist",
    "description": "Founder of Lung Focus and Expert Interventional Pulmonologist specializing in minimally invasive procedures for complex respiratory conditions, EBUS procedures, thoracic oncology, and airway interventions.",
    "url": "https://www.lungfocus.com",
    "image": "https://www.lungfocus.com/images/Dr-Kedar-Hibare-01.jpeg",
    "telephone": "+91-80-6122-2000",
    "email": "info@lungfocus.com",
    "address": {
      "@type": "PostalAddress",
