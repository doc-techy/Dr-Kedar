...
export default function ServicesSection() {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ["Asthma Management", "COPD Management", "Bronchiectasis Care"]
    },
    {
      ...
      features: ["Pulmonary Hypertension", "Pulmonary Embolism", "Vascular Assessment"]
    },
    {
      title: "Tuberculosis",
      ...
      features: ["Tuberculosis Diagnosis", "Tuberculosis Treatment"]
    }
  ]
