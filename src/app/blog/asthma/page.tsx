        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`prose prose-base max-w-none ${
            ...
            <section className="mb-12">
              ...
              <p className={`text-sm mt-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            ...
            <section className="mb-12">
              ...
              <p className={`text-xs italic mt-4 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <section className="mb-12">
              ...
              <p className={`text-sm mt-4 font-semibold ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`}>
